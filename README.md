...
*Last updated: 2025-06-19 15:19:33*
...
| 🌐 **Default WASM** | `(default -opt=z)` | 580.8 KB | 273.5 KB | **-307.4 KB** | ✅ **52.9%** |
| 🌐 **Ultra WASM** | `-no-debug -panic=trap -scheduler=none -gc=leaking -target wasm` | 141.3 KB | 36.6 KB | **-104.7 KB** | 🏆 **74.1%** |
| 🌐 **Speed WASM** | `-opt=2 -target wasm` | 827.0 KB | 339.3 KB | **-487.6 KB** | ✅ **58.0%** |
| 🌐 **Debug WASM** | `-opt=0 -target wasm` | 1.8 MB | 934.8 KB | **-897.8 KB** | ✅ **48.0%** |

### 🎯 Performance Summary

- 🏆 **Peak Reduction: 74.1%** (Best optimization)
- ✅ **Average WebAssembly Reduction: 58.7%**
...
*Last updated: 2025-06-19 15:19:53*
...
| | 🚀 TinyString | `2.8 KB` | `119` | `13.9μs` | ❌ **140.3% more** | ❌ **147.9% more** | ❌ **Poor** |
| 🔢 **Number Processing** | 📊 Standard | `912 B` | `42` | `2.6μs` | - | - | - |
| | 🚀 TinyString | `4.4 KB` | `88` | `5.9μs` | ❌ **389.8% more** | ❌ **109.5% more** | ❌ **Poor** |
